...
@bot.callback_query_handler(func=lambda call: call.data == "calc_technical")
def calc_technical(call: CallbackQuery):
    ...
    with bot.retrieve_data(call.from_user.id, call.message.chat.id) as data:
        data["tariff_name"] = "Технический проект"
        data["tariff_code"] = "technical"
