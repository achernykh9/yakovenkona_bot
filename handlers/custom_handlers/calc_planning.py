...
@bot.callback_query_handler(func=lambda call: call.data == "calc_planning")
def calc_planning(call: CallbackQuery):
    ...
    with bot.retrieve_data(call.from_user.id, call.message.chat.id) as data:
        data["tariff_name"] = "Планировочное решение"
        data["tariff_code"] = "planning"
